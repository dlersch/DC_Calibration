...
import javax.swing.*;
import org.kp.myLib1.KpLib1;
//import static org.kp.myLib1.KpLib1.*;
...
public class DC_CalibrationNew extends WindowAdapter implements WindowListener,  ActionListener, Runnable
{
	...
	//frame.setBounds(0,0,frameSize.width,frameSize.height);//kp 0,0 is the coordinate of top-left corner

        
                //Set up banner to use as custom preview panel
        banner = new JLabel("Welcome to DC calibration for CLAS12 ... !",
                JLabel.CENTER);
        ...
        //kp: http://stackoverflow.com/questions/1783793/java-difference-between-the-setpreferredsize-and-setsize-methods-in-compone
        ...
        p2buttons.add(bT0Cor,BorderLayout.LINE_START); //WEST); //WEST also works
	...
	buttonClear=new JButton("clear");
        ...
        //ImageIcon imageIcon = new ImageIcon(this.getClass().getResource("images/timeVsTrkDoca_and_Profiles.png"));
        ...
        //I think we need getContentPane() with JFrame, but not with JPanel object
        //   I guess, getContentPane() is equivalent to getting the JPanel object contained in the frame.
	...
	//buttonClear.addActionListener(this);
        ...
        //kp: This try-catch is to redirect standard output to first PipedOutputStream named "pout"
        //kp:    and that "pout" stream is piped/passed to "pin" (pout is sender, pin is receiver)
	try
	    {
                //kp: http://www.java2s.com/Tutorials/Java/Java_io/0300__Java_io_Pipe.htm
                //kp: 'pout' constructed and then connected to the other end of the pipe of which one end is 'pin'
		PipedOutputStream pout=new PipedOutputStream(this.pin);
                
                //https://www.tutorialspoint.com/java/lang/system_setout.htm (see setOut used on FileOutputStream)
        ...
        //kp: This try-catch is to redirect standard errors (or err-stream) to second PipedOutputStream named "pout2"
        //kp:    and that "pout2" stream is piped/passed to "pin2" (pout2 is sender, pin2 is receiver)
	try
	    {
	...
	//
        //kp: Following reader, and reader2 are instances (objects) of this class (i.e. aSimpleJavaConsole) itself
	reader=new Thread(this);  
	reader.setDaemon(true);  //kp: make this thread a process running in the background (no interactive access)
	...
	*/
	...
	this.notifyAll(); // stop all threads (kp: notify All threads?)
        //kp: https://docs.oracle.com/javase/tutorial/essential/concurrency/join.html
	...
	*/
	...
	do
		...
		byte b[]=new byte[available]; //kp: creating a 'byte' array of size 'available'
		in.read(b); 
	...
	try
		...
		while(cnt.reader.isAlive() || cnt.reader2.isAlive() )
			...
			for (int i=0 ;i<4;i++)
				...
				println("Printing the count with my own println (KpLib1) " + i); //method defined in my own library
				Thread.sleep(1000);
			    }
                        kpLoopBreaker++;
                        System.out.println("========kpLoopBreaker = " + kpLoopBreaker+"=============");
                        //if(kpLoopBreaker>3) break;
                        if(kpLoopBreaker>300) break;
		    }
	    }
	...
	System.out.println("Main thread run is over" );
        ...
        //kp: http://www.java67.com/2015/06/how-to-pause-thread-in-java-using-sleep.html
        try {
